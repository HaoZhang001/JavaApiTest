...
public class CCi_ControlSpeaker {
    WebDriver driver;
    ...
    @Test
    public void singlePersonFunTest() {
        String mN = "Auto-测试会议201426";
        ...
        cMM.enterVideoMeeting();
        cMM.filterOnlinePeople();
        cMM.setAsSpeaker(driver);
        cMM.cancelSpeaker(driver);
    }
